...
<body class='bg-dark'>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active bg-white text-dark" href="./staff_list.php">Staff List</a>
                        </li>
                    </ul>
                </div>
                <form>
    ...
    <div class="container-fluid" id="container">
        <h1 class="text-center text-white p-5" id="page-title">Staff List</h1>
        <div class="card bg-secondary text-white">
            <div id="card-header">
                <form action="" class='card-header row g-0 text-white' id='user-search'>
                    ...
                    <div class="col-auto py-2 px-4">
                        <label for="user-job" class="form-label text-white">Job name :</label>
                        <input type="text" name="user-job" class="form-control form-text" id="user-job-search" placeholder="Job name">
                    </div>
                    <div class="col-auto py-2 px-4">
                ...
                <table class='table table-bordered table-secondary table-striped table-hover'>
                    <thead>
                        <tr>
                            ...
                            <th scope="col" width='15%'>Job</th>
                            <th scope="col" width='20%'>Description</th>
                            <th scope="col" width='5%'>Salary</th>
                            <th scope="col" width='5%'>Executive</th>
    ...
    <div id='scripts'>
        <script src="./scripts/staff_search.js"></script>
    </div>
</body>
