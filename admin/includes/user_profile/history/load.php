    ...
    if ($total_links == 0) {
        ...
        for ($count = 0; $count < count($page_array); $count++) {
			...
			';
                ...
                if ($previous_id > 0) {
                    $previous_link = '<li class="page-item"><a class="page-link bg-dark text-white" href="javascript:userHistory(`' . $userId . '`, ' . $limit . ', ' . $previous_id . ')">Previous</a></li>';
                } else {
                    $previous_link = '
				...
				';
                    ...
                    $next_link = '
				<li class="page-item"><a class="page-link bg-dark text-white" href="javascript:userHistory(`' . $userId . '`, ' . $limit . ', '  . $next_id . ')">Next</a></li>
				';
                }
            } else {
                if ($page_array[$count] == '...') {
				...
				';
                    ...
                    $page_link .= '
				<li class="page-item">
					<a class="page-link bg-dark text-white" href="javascript:userHistory(`' . $userId . '`, ' . $limit . ', '  . $page_array[$count] . ')">' . $page_array[$count] . '</a>
				</li>
				';
                }
            }
